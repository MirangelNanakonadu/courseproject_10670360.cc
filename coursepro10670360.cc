...
int main()
{
    ...
    do
   {
    ...
    else
    {
        ...
        case 2:
            cout << "\n Enter the ID No. of the Student to obliterate: " << endl;
            ...
            {
                stud[j].id = 'd';
                cout << "\t Record Successfully obliterated";
                  }
            }
                    break;
        case 3:
    ...
    break;
      ...
      break;
        ...
        case 2:
            cout << "You Can Edit/Add/obliterate Staff Records: " << endl;
             ...
             do
   {
    ...
    switch(sw)
    {
        ...
        cout << "\n Enter the details of the Staff " << arr2+1 << " is :" << endl;
    ...
    else
    {
        ...
        case 2:
            cout << "\n Enter the ID No. of the Staff to obliterate: " << endl;
